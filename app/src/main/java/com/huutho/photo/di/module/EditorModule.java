...
public class EditorModule {
    ...
    List<Rotate> provideRotate() {
        ...
        rotates.add(new Rotate("Rotate left", R.drawable.icon_rotate_left));
        rotates.add(new Rotate("Rotate right", R.drawable.icon_rotate_right));
        rotates.add(new Rotate("Rotate left & right", R.drawable.icon_rotate_left_and_right));
        rotates.add(new Rotate("Rotate up & down", R.drawable.icon_rotate_up_and_down));
        return rotates;
    }
    ...
    Map<String, Object> provideAdjust() {
        ...
        adjusts.add(new Adjust("Sharpness", R.drawable.icon_adjust_shaprness_dark, "Sharpness", 3, -1.0f, 10.0f, 0.0f));
        adjusts.add(new Adjust("Temperature", R.drawable.icon_adjust_temperature_dark, "Vignette", 4, 0.0f, 1.0f, 0.5f));
        adjusts.add(new Adjust("Hue", R.drawable.icon_adjust_hue_dark, "Vignette", 4, 0.0f, 1.0f, 0.5f));
        adjusts.add(new Adjust("Brightness", R.drawable.icon_adjust_brightness_dark, "Brightness", 0, -1.0f, 1, 0));
        adjusts.add(new Adjust("Contrast", R.drawable.icon_adjust_contrast_dark, "Contrast", 1, 0.1f, 3.0f, 1.0f));
        adjusts.add(new Adjust("Vibrance", R.drawable.icon_adjust_vibrance_dark, "Vignette", 4, 0.0f, 1.0f, 0.5f));
        adjusts.add(new Adjust("Saturation", R.drawable.icon_adjust_saturation_dark, "Saturation", 2, 0.0f, 3.0f, 1.0f));
        adjusts.add(new Adjust("Vignette", R.drawable.icon_adjust_vignette_dark, "Vignette", 4, 0.0f, 1.0f, 0.5f));
        adjusts.add(new Adjust("Light Center", R.drawable.icon_adjust_light_center_dark, "Vignette", 4, 0.0f, 1.0f, 0.5f));
